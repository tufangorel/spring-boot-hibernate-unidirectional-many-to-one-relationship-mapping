...
public class OrderItemController {
    ...
    @Operation(summary = "Find a customer by a given order item id")
    @GetMapping(value="/find/customer/orderitem/{orderItemID}", produces = "application/json")
    public ResponseEntity findCustomerByOrderItemID(@PathVariable Integer orderItemID){
        Customer relatedCustomer = orderItemService.findCustomerByOrderItemID(orderItemID);
        return new ResponseEntity<Customer>( relatedCustomer, HttpStatus.OK );
    }
